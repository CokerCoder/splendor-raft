...
import com.da.scheduler.DefaultScheduler;
...
public class ServerLauncher {
    ...
    private volatile KVServer server;
    ...
    //             .build();
    //     KVServer server = new KVServer(node, portService);
    ...
    private void startAsGroupMember(CommandLine cmdLine) throws Exception {
        ...
        KVServer server = new KVServer((RaftNode) node, portService);
    ...
    private void startServer(KVServer server) throws Exception {
        this.server = server;
        this.server.start();
